...
Im Rahmen des #DataDeepDive-Hackathons haben Journalistinnen von NOZ und mh:n Medien (Barbara Maas und Anna Behrend) gemeinsam mit Programmierern (Robert Höfig und Richard Meinsen) einen Prototypen für ein solches Tool entwickelt. Die Daten der amtlichen Statistik werden dabei über die [Datenguide-API](https://github.com/datenguide/datenguide/blob/main/docs/_api-docs/api_docs.md) geladen.

<ArrowLink href="https://www.presseportal.de/pm/8218/4131855">
  Mehr über den Hackathon und die Preisträger-Projekte
</ArrowLink>
