...
<Link href="https://observablehq.com/@stefanw/parsing-eu-parliament-vote-pdfs"><Image className="contentImage" src={require('./abstimmungen.png')} alt="Visualisierung des Abstimmungsverhaltens im Europaparlament"/></Link>
...
<Link href="https://wahlprogrammquiz.de"><Image className="contentImage" src={require('./wahlprogramme.png')} alt="Wahlprogramm-Quiz"/></Link>
...
<Image className="contentImage" src={require('./wahlbeteiligung.jpg')} alt="Kartenvisualisierung der Wahlbezirke in Berlin"/>
