...
Um zum Beispiel deutschlandweit das Durchschnittsalter der Bevölkerung zu vergleichen, gibt es auf erster Ebene die **16&nbsp;Bundesländer (NUTS-1-Regionen)**. Die Bevölkerung einer NUTS-1-Region liegt in aller Regel zwischen 3 und 7 Millionen
Einwohnern.
