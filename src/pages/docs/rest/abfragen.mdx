...
Viele Beispiele für mögliche Abfragen findet ihr [auf Github](https://github.com/datenguide/genesapi-tabular/blob/master/examples.ipynb). Wir haben außerdem [Beispiele für Python](rest/verwendung-mit-python) und [JavaScript](rest/verwendung-mit-javascript) zusammengestellt.
