...
Viele Beispiele für mögliche Abfragen findet ihr [auf Github](https://github.com/datenguide/genesapi-tabular/blob/main/examples.ipynb). Wir haben außerdem Beispiele für die [Verwendung mit Python](verwendung-mit-python) und [JavaScript](verwendung-mit-javascript) zusammengestellt.
