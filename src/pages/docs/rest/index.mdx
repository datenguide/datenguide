...
Sämtliche an die REST-Schnittstelle gesendeten Abfragen folgen diesem Aufbau. Auf der nächsten Seite sehen wir uns den Aufbau der URL genauer an.

<p>
  <Button href="rest/abfragen" variant="outlined" color="primary" size="large">
