...
<BlogHeader {...frontmatter}>
  <Image src={require('./tables/header.svg')} />
</BlogHeader>
...
<Grid container direction="row" justify="center" spacing={2}>
  <Grid item xs={12} sm={6}>
    <Image className="contentImage" src={require('./tables/d_01.png')} alt="Suche Region" />
    <small>Region auswählen</small>
  </Grid>
  <Grid item xs={12} sm={6}>
    <Image className="contentImage" src={require('./tables/d_02.png')} alt="Auswahl regionale Tiefe" />
    <small>Ebene festlegen</small>
  </Grid>
  <Grid item xs={12} sm={6}>
    <Image className="contentImage" src={require('./tables/d_02_01.png')} alt="Merkmal suchen" />
    <small>Merkmal suchen</small>
  </Grid>
  <Grid item xs={12} sm={6}>
    <Image className="contentImage" src={require('./tables/d_03.png')} alt="Merkmal wählen" />
    <small>Merkmal auswählen</small>
  </Grid>
  <Grid item xs={12} sm={6}>
    <Image className="contentImage" src={require('./tables/d_04.png')} alt="Jahr wählen" />
    <small>Jahr wählen</small>
  </Grid>
  <Grid item xs={12} sm={6}>
    <Image className="contentImage" src={require('./tables/d_05.png')} alt="Download" />
...
<Image className="contentImage" src={require('./tables/d_06.png')} alt="Import" />
...
<Grid container direction="row" justify="center" spacing={2}>
  <Grid item xs={12} sm={6}>
    <Image className="contentImage"  src={require('./tables/01_suche.png')} alt="Suchergebnis Themen" />
  </Grid>
  <Grid item xs={12} sm={6}>
    <Image className="contentImage"  src={require('./tables/01_download.png')} alt="Download" />
  </Grid>
</Grid>
...
<Image className="contentImage"  src={require('./tables/02_header.png')}/>
...
<Grid container direction="row" justify="center" spacing={2}>
  <Grid item xs={12} sm={6}>
    <Image className="contentImage"  src={require('./tables/04_settings.png')} alt="Import"/>
  </Grid>
  <Grid item xs={12} sm={6}>
    <Image className="contentImage"  src={require('./tables/04_number_format.png')} alt="Import"/>
  </Grid>
</Grid>

<Image className="contentImage"  src={require('./tables/04_number.png')} alt="Import"/>
...
<Image className="contentImage"  src={require('./tables/06_vor_pivot.png')} alt="Import"/>
...
<Image className="contentImage"  src={require('./tables/06_pivot.png')} alt="Import"/>
...
<Image className="contentImage"  src={require('./tables/07_datawrapper.png')} alt="Import"/>
